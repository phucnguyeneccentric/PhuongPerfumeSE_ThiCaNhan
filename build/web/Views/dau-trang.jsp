            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="${param.page==1?"active":""}"><a href="trang-chu.jsp">Trang chủ</a></li>
                        <li class="${param.page==2?"active":""}"><a href="trang-cua-hang.jsp">Cửa hàng</a></li>
                        <li class="${param.page==3?"active":""}"><a href="trang-san-pham.jsp">Sản phẩm</a></li>
                        <li class="${param.page==4?"active":""}"><a href="trang-gio-hang.jsp">Giỏ hàng</a></li>
                        <li class="${param.page==5?"active":""}"><a href="trang-thanh-toan.jsp">Thanh toán</a></li>
                    </ul>
                </div>  
            </div>
        </div>
